...
if num1 > num2 and num1 > num3:
    ...
    print(f'\33[31mNão é possível determinar o maior número já que há dois ou mais valores iguais!\33[m')
if num1 < num2 and num1 < num3:
    ...
    print('\33[31mNão é possível determinar o menor número já que há dois ou mais valores iguais!\33[m')